...
public class UPP {
    ...
    private UserPrivacyPolicy userPrivacyPolicy;
    
    /** The additional properties. */
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    /**
     * Gets the user privacy policy.
     *
     * @return     The userPrivacyPolicy
     */
    ...
    /**
     * Sets the user privacy policy.
     *
     * @param userPrivacyPolicy     The UserPrivacyPolicy
     */
