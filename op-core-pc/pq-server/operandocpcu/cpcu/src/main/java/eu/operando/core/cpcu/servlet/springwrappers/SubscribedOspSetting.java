...
/**
 * The Class SubscribedOspSetting.
 */
@Generated("org.jsonschema2pojo")
public class SubscribedOspSetting {

    /** The osp id. */
    private String ospId;
    
    /** The osp settings. */
    private List<OspSetting> ospSettings = new ArrayList<OspSetting>();
     ...
     */
    public List<OspSetting> getOspSettings() {
        return ospSettings;
    }
     ...
     */
    public void setOspSettings(List<OspSetting> ospSettings) {
