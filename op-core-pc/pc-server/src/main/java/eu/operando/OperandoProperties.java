...
/**
 * The set of operations to allow the PC module to read the properties file and
 * configure all aspects of the module deployment.
 *
 * For example, identifying the URL endpoints of other Operando modules.
 *
 */
public class OperandoProperties {
