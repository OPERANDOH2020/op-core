...
@Path("/osp_policy_batch_evaluator")
...
public class OspPolicyBatchEvaluatorApi  {
   private final OspPolicyEvaluatorApiService delegate = OspPolicyEvaluatorApiServiceFactory.getOspPolicyEvaluatorApi();
    ...
    public Response ospPolicyEvaluatorBatchPost(
    ...
    throws NotFoundException {
        return delegate.ospPolicyBatchEvaluatorPost(ospId,ospRequest,securityContext);
    }
}
