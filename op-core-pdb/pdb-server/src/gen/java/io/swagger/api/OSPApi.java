...
,@Context SecurityContext securityContext, @Context HttpHeaders headers)
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 201, message = "The statements (AccessReason) was successfully created in the list.", response = void.class),
        
        @io.swagger.annotations.ApiResponse(code = 405, message = "Error. The document (AccessReason) at this id has previously been created in the list.", response = void.class) })
...
,@Context SecurityContext securityContext, @Context HttpHeaders headers)
    ...
    @io.swagger.annotations.ApiOperation(value = "Create a new OSP entry in the database.", notes = "Called by the policy computation component when a new regulation is added to OPERANDO. ", response = String.class, tags={ "OSP","POST", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 201, message = "The document (OSPBehaviour) was successfully created in the database. The Operando user-id is returned as a string parameter", response = String.class),
        
        @io.swagger.annotations.ApiResponse(code = 405, message = "Error. The document (OSPBehaviour) at this id has previously been created in the database.", response = String.class) })
