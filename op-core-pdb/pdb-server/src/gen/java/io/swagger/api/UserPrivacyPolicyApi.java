...
public class UserPrivacyPolicyApi  {
   private final UserPrivacyPolicyApiService delegate = UserPrivacyPolicyApiServiceFactory.getUserPrivacyPolicyApi();
    ...
    @io.swagger.annotations.ApiOperation(value = "Perform a search query across the collection of UPPs.", notes = "The query contains a json object (names, values) and the request returns the list of documents (UPPs) where the filter matches i.e. each document contains fields with those values.\n", response = UserPrivacyPolicy.class, responseContainer = "List", tags={ "UPP", "GET",  })
    ...
    public Response userPrivacyPolicyGet(
    ...
    @io.swagger.annotations.ApiOperation(value = "Create a new UPP entry in the database for the user.", notes = "Called when a new user is registered with operando. Their new privacy\npreferences are passed in the UPP document and stored in the policy DB.\n", response = void.class, tags={ "UPP", "POST",  })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response userPrivacyPolicyPost(
        @ApiParam(value = "The first instance of this user's UPP" ,required=true) UserPrivacyPolicy upp,
        @Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiOperation(value = "Remove the UPP entry in the database for the user.", notes = "Called when a user leaves operando. Their privacy preferences and\npolicies are deleted from the database.\n", response = void.class, tags={ "UPP", "DELETE",  })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response userPrivacyPolicyUserIdDelete(
    ...
    @io.swagger.annotations.ApiOperation(value = "Read the user privacy policy for the given user id.", notes = "Get a specific UPP document via the user's id. This will return the full user privacy policy document in json format.\n", response = UserPrivacyPolicy.class, tags={ "UPP", "GET",  })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response userPrivacyPolicyUserIdGet(
        @ApiParam(value = "The user identifier number",required=true) @PathParam("user-id") String userId,
        @Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiOperation(value = "Update UPP entry in the database for the user.", notes = "Called when a user makes a change to the UPP registered with operando.\nTheir new privacy preferences are passed in the UPP document and stored\nin the policy DB.\n", response = void.class, tags={ "UPP", "PUT" })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response userPrivacyPolicyUserIdPut(
        @ApiParam(value = "The user identifier number",required=true) @PathParam("user-id") String userId,
