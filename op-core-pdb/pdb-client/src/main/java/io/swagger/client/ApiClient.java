...
public class ApiClient {
    ...
    private String basePath = "http://operando.eu/policy_database";
     ...
     * i.e. objectMapper and debugging. TODO: better to use the Builder Pattern?
     */
    public ApiClient rebuildHttpClientORIG() {
