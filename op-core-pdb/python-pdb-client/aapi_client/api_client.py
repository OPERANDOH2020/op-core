...
class ApiClient(object):
    """
    Generic API client for AAPI client library builds.

    AAPI generic API client. This client handles the client-
    ...
    def sanitize_for_serialization(self, obj):
        ...
        if isinstance(obj, dict):
            ...
            obj_dict = {obj.attribute_map[attr]: getattr(obj, attr)
                        for attr, _ in iteritems(obj.aapi_types)
    ...
    def __deserialize_model(self, data, klass):
        ...
        if not instance.aapi_types:
            return data

        for attr, attr_type in iteritems(instance.aapi_types):
            if data is not None \
