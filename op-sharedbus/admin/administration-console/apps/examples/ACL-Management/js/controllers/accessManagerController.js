'use strict';
app.controller('accessManagerController', ['$scope','ModalService','swarmService',"authenticationService",
    function ($scope,ModalService,swarmService,authenticationService) {
        ...
        //TO DO:  clarify what the dummy functions above should actually do
...
app.controller('createRuleController', ['$scope','type','predefinedInputs','specificLabels',"$element",'close', function($scope,type,predefinedInputs,specificLabels,$element, close) {
    $scope.rule = {};
    $scope.type = type;
...
app.controller('editRuleController',['$scope','rule', '$element','close', function($scope,rule,$element, close) {
    $scope.rule = {};
