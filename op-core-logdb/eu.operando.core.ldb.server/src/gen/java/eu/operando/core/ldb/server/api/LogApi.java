...
import eu.operando.core.ldb.server.api.impl.Secured;
...
public class LogApi {
	...
	@io.swagger.annotations.ApiOperation(value = "Inserts received data to the database.", notes = "Inserts received data to the database by using Log4j.", response = String.class, tags = {
			"Log", })
	@io.swagger.annotations.ApiResponses(value = {
			@io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = String.class) })
	public Response log(
			@ApiParam(value = "The request data in JSON format to be inserted in the database by using Log4j", required = true) LogRequestExt request,
	...
	@io.swagger.annotations.ApiOperation(value = "Inserts received data to the database.", notes = "Inserts received data to the database by using Log4j.", response = void.class, authorizations = {
			@io.swagger.annotations.Authorization(value = "service-ticket") }, tags = { "Log", })
	@io.swagger.annotations.ApiResponses(value = {
