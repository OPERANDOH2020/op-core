...
public class OffersApiServiceImpl extends OffersApiService {
    ...
    @Override
    public Response createOffer(Offer offer, SecurityContext securityContext)
    ...
    @Override
    public Response updateOffer(String offerId, Offer offer, SecurityContext securityContext)
    throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
