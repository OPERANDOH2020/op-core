...
public class OffersApi  {
   private final OffersApiService delegate = OffersApiServiceFactory.getOffersApi();
    ...
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Creates a new offer for an OSP .", notes = "Request from Administration Console to create a new offer for an OSP.", response = InlineResponse2002.class, tags={ "Offers",  })
...
@ApiParam(value = "The offer data in JSON format." ,required=true) Offer offer,@Context SecurityContext securityContext)
...
@ApiParam(value = "The offer identifier number",required=true) @PathParam("offer_id") String offerId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Search offers in databse", notes = "Extension or management console send request to PfB service to get a list of offers by specific search terms (e.g Gets offers related to a website  when signup page is detected)", response = InlineResponse2001.class, tags={ "Offers",  })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response getOffers(@ApiParam(value = "URL of the website to get offers related to specific URL") @QueryParam("website_url") String websiteUrl
